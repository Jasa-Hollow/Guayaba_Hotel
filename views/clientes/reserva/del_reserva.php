<?php
    ...
    if ($DeleteReserva && $DeleteFecha) {
        echo '
        <script type="text/javascript"> swal("Estimado cliente", "¡Se ha eliminado su reserva!", "success"); </script>
        <div class="alert alert-success">
            <div class="modal-body">
                <div class="jumbotron text-center">
                    <h2 class="disply-4">¡Puedo observar otras habitaciones sí gusta!</h2>
                    <hr class="my-4">
        ...
        <div class="alert alert-danger">...Error al cancelar su reserva...</div>';
    }
